...
if (!((window._atc || {}).ver))
{
    ...
    var _atd = "www.addthis.com/",
        ...
        _atc = {
            dbg: 0, rrev: 126504, dr: 0, ver: 250, loc: 0, enote: "", cwait: 500, bamp: 0.25, camp: 1, csmp: 0.0001, damp: 1, famp: 1, pamp: 0.1, sfmp: 0.1, tamp: 1, plmp: 1, vamp: 1, cscs: 1, ohmp: 0, ltj: 1, xamp: 1, abf: !!window.addthis_do_ab, qs: 0, cdn: 0, rsrcs: {
                ...
                core: _atr + "static/r07/core121.js",
                ...
                layersjs: _atr + "static/r07/layers036.js",
                layerscss: _atr + "static/r07/layers032.css",
                ...
                linkedin: _atr + "static/r07/linkedin022.html",
                fbshare: _atr + "static/r07/fbshare004.html",
                tweet: _atr + "static/r07/tweet027.html",
                menujs: _atr + "static/r07/menu161.js",
                sh: _atr + "static/r07/sh148.html"
            }
        };

    //alert(_atr + "static/r07/counter014.css");
}
(function ()
{
    ...
    var s = (window.location.protocol == "https:"),
        ...
        n,
        y,
        A = (navigator.userAgent || "unk").toLowerCase(),
        v = (/firefox/.test(A)),
        p = (/msie/.test(A) && !(/opera/.test(A))),
        c = { 0: _atr, 1: "//ct1.addthis.com/", 6: "//ct6z.addthis.com/" },
        g = { gb: "1", nl: "1", no: "1" },
        o = { gr: "1", it: "1", cz: "1", ie: "1", es: "1", pt: "1", ro: "1", ca: "1", pl: "1", be: "1", fr: "1", dk: "1", hr: "1", de: "1", hu: "1", fi: "1", us: "1", ua: "1", mx: "1", se: "1", at: "1" },
        E = { nz: "1" },
        h = (h = document.getElementsByTagName("script")) && h[h.length - 1].parentNode; _atc.cdn = 0;
            ...
            var m = 10000; setTimeout(function () {
                if (!window.addthis.timer.core) {
                    ...
                    if (_atc.cdn !== 0) {
                        var d = document.createElement("script");
                        d.type = "text/javascript";
                        d.src = (s ? "https:" : "http:") + _atr + "static/r07/core121.js"; h.appendChild(d);
                    }
                }
            }, m);
        }
